...
let intro__contenido__capa = seccion__intro.querySelector(
  ".intro__contenido__capa"
);
let intro__contenido__logohdden = seccion__intro.querySelector(
  ".intro__contenido__logohdden"
);
let intro__contenido__imagen = seccion__intro.querySelector(
  ".intro__contenido__imagen"
);
let intro__contenido__marquesina = seccion__intro.querySelector(
  ".intro__contenido__marquesina"
);
let intro__contenido__video = seccion__intro.querySelector(
...
function animateMoverLogo() {
  let main__LogoCollection_cnt = document.querySelector(
    ".main__contenedorLogoCollection"
  );
  let main__logocollection_img = main__LogoCollection_cnt.querySelector(
