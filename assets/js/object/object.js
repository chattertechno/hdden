window.addEventListener('load', function () {
    ...
    const Object1Himg__svgPathSto = document.querySelector('.object1Himg .object1Himg__sto')
    ...
    Object1Himg__svgPathSto.addEventListener('mouseover', () => {
    ...
    Object1Himg__svgPathSto.addEventListener('mouseout', () => {
    ...
    if (isMobile == false) {
        ...
        const object1Section1__titulo = document.querySelector(".object1Section1__titulo")
        const object1Section1__ul = document.querySelector(".object1Section1__ul")
        const object1Section1__photo = document.querySelector(".object1Section1__photo")
        ...
        tl__object1Section1
            .from(object1Section1__titulo, {
                opacity: 0,
                yPercent: 5,
            }, '<')
            .from(object1Section1__photo, {
                xPercent: 5,
            }, '<')
            .from(object1Section1__ul, {
                xPercent: -5,
            }, '<')

        // Sección object1Section2 ---------------------------------------------
        const object1Section2 = document.querySelector("#object1Section2")
        const object1Section2__photo1 = document.querySelector(".object1Section2__photo1")
        const object1Section2__photo2 = document.querySelector(".object1Section2__photo2")
        const object1Section2__link = document.querySelector(".object1Section2_link")
        ...
        const object1Section3__titulo = document.querySelector(".object1Section3__titulo")
        const object1Section3__photo1 = document.querySelector(".object1Section3__photo1")
