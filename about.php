  ...
  <main class="main">
    ...
    <section id="aboutSection" class="seccion__about">
      <div class="aboutSection_contenido">
        ...
        <p class="about-texto txt-1">César, who also designs under the moniker Antipop, comes from México. He has a
          degree in
          architecture and is
          responsible for all things related to Web 3.0 and design. His designs have won multiple international awards
          over the years. <a href="https://www.linkedin.com/in/cesarbejarano/" target="_blank">View Linkedin</a></p>

        <p class="about-texto txt-2">A certified and expert cabinet maker with more than 10 years of experience, Gabriel
          is a
          native of Spain. He runs the workshop and with exceptional craftsmanship is able to turn César’s designs into
          finished masterpieces.
          <!-- <a href="javascript:void(0)">View Linkedin</a> -->
        </p>

        <p class="about-texto txt-3">Both are 1/2 of a whole, and Hdden Forms could not exist without either one.</p>

        <div class="about-equipo">
          <h2>Team <br>Members:</h2>
          <a href="https://www.linkedin.com/in/cesarbejarano/" target="_blank">Founder/Artist: César Bejarano</a>
          <a href="https://www.instagram.com/ga_hdden/" target="_blank">Founder/Cabinet Maker: Gabriel Canedo</a>
          <a href="https://www.linkedin.com/in/javier-ram%C3%B3n-miranda-126475106/" target="_blank">Founder/Director:
            Javier Ramón</a>
          <a href="https://www.linkedin.com/in/reneekrom/" target="_blank">Web 3.0 Developer: Renee Krom</a>
          <a href="https://metodika.mx/" target="_blank">Front End Developer: Metodika</a>
