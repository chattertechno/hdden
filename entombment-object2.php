...
<body>
  ...
  <main class="object1__contenido">
    ...
    <section id="object1Hero" class="">
      ...
      <svg class="object1Himg" viewBox="3 -1.95 570 872">
        <path class="object1Himg__sto"
    ...
    <section id="object1Section1">
      <div class="object1Section1_contenido">
        ...
        <p>Object 2 is the first object released from The Entombment Collection. It is constructed 100% entirely out
          of wood, with no metal supports of any type used for the complex system of joinery.</p>
        <p>The positioning of the spheres, along with their small areas of contact, provide Object 2 with a false
    ...
    <section id="object1Section2">
      <img class="object1Section2__photo1 gs_reveal gs_reveal_fromRight" src="./assets/img/collection/photo2_obj2.png"
        alt="photo">
      <div class="object1Section2_contenido">
        <a href="javascript:void(0)" class="object1Section2_link btn btn-circulo-verde btn-circulo-verde--lg gs_reveal"
          href="#object1Section2">Set an Auction<br> Reminder</a>
        <img class="object1Section2__photo2 gs_reveal gs_reveal_fromLeft" src="./assets/img/collection/photo3_obj2.jpg"
          alt="Object">
      </div>
    </section>
    ...
    <section id="object1Section3">
      <div class="object1Section3_contenido">
        <img class="object1Section3__photo1 gs_reveal gs_reveal_fromLeft" src="./assets/img/collection/photo4_obj2.jpg"
          alt="Object">
        <img class="object1Section3__photo1 gs_reveal gs_reveal_fromRight" src="./assets/img/collection/photo5_obj2.jpg"
          alt="Object">
    ...
    <div class="modal-reminder">
      ...
      <form action="./assets/data/send.php" autocomplete="off" method="POST" id="formAuctionReminder">
        ...
        <div class="modal_checkboxes">
          <label><input name="remind_auction_dates" type="checkbox" value="1"> Remind me of auction dates</label>

          <label><input name="receive_news" type="checkbox" value="1"> I would like to receive all the news and
            updates</label>
        </div>
